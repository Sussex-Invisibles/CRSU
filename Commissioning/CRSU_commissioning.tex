...
\begin{figure}[htp]
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Hardware/CRSU_final.jpg}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.8\textwidth,trim={0 3mm 0 1mm},clip]{\string~/Dropbox/CRSU/Network/Latency/Legacy/dbug_martti_tests_2.pdf}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.8\textwidth,trim={0 3mm 0 1mm},clip]{\string~/Dropbox/CRSU/Network/Latency/Legacy/dbug_martti_tests_mac.pdf}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Linux/SNOLAB_ping_failures.png}
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Linux/SNOLAB_dead_time.png}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Mac/SNOLAB_ping_failures.png}
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Mac/SNOLAB_dead_time.png}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Linux/VPN_ping_failures.png}
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Linux/VPN_dead_time.png}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Mac/VPN_ping_failures.png}
% 	\includegraphics[width=\textwidth,trim={5mm 7mm 5mm 5mm},clip]{\string~/Dropbox/CRSU/Network/Connectivity/Monitoring_Mac/VPN_dead_time.png}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={0 3mm 0 1mm},clip]{\string~/Dropbox/CRSU/Network/Latency/Legacy/dbug_no_load_linux.pdf}
...
% 
% \begin{figure}[htp]
% 	\includegraphics[width=\textwidth,trim={0 3mm 0 1mm},clip]{\string~/Dropbox/CRSU/Network/Latency/Legacy/dbug_no_load_mac.pdf}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu1_latency}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu2_latency}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/opersu_latency}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu1_latency_zoom}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu2_latency_zoom}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/opersu_latency_zoom}
	\caption{Same as \Cref{latency_final_1}, but showing only the latencies for SNOLAB hosts, as a scatterplot on a linear scale. It can clearly be seen when CRSU was running under load, i.e. taking shifts (graveyard shifts from 28/05/2018 to 31/05/2018). The VPN connection (black dots) however remains stable at a relatively low 102~ms.}
	\label{latency_final_2}
\end{figure}

\begin{figure}[htp]
	\centering
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu1_latency_zoom_shift}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/monsu2_latency_zoom_shift}\\
	\includegraphics[width=\textwidth]{\string~/Dropbox/CRSU/Network/Latency/Pevensey/opersu_latency_zoom_shift}
